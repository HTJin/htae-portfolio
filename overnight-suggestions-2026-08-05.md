...
- [ ] **S90 - The engine kept running after you left the tab** - Status: Done - Cycle: 53
  ...
  - **Outcome:** **Shipped** in `78d7f0f`. Leaving the tab now suspends the sound and coming back restores it - and it restores *your* choice, rather than switching sound on for you.
